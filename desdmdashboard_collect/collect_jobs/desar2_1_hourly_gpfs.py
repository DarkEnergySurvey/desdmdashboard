...
from desdmdashboard_collect.collect_functions.desar2_iosystem_gpfs import gpfs_connections
...
if __name__ == '__main__':
    logger.info('Start 1 hourly data collection script. (gpfs_connections)')
    main()
    logger.info('1 hourly data collection script finished. (gpfs_connections)')
