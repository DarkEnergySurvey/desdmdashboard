...
def main():
    fermigrid_connections()
    

if __name__ == '__main__':
    logger.info('Start 1 hourly data collection script. (fermigrid_connections)')
    main()
    logger.info('1 hourly data collection script finished. (fermigrid_connections)')
